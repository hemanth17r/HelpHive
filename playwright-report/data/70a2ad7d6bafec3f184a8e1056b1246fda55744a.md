...
- Name: tasker\3-activity-and-payments.spec.js >> Tasker Activity & Payments Screen >> should expand active jobs list on "Show All" click
- Location: tests\e2e\tasker\3-activity-and-payments.spec.js:122:3
...
Call log:
  - waiting for locator('.rounded-full').filter({ has: locator('svg, img') }).first()
    - locator resolved to <div class="w-9 h-9 md:w-10 md:h-10 rounded-full border border-primary/20 overflow-hidden bg-orange-50 flex items-center justify-center shrink-0 shadow-sm">…</div>
...
- main [ref=e6]:
  - generic [ref=e8]:
    - generic [ref=e9]:
      - img [ref=e11]
      - heading "HelpHive" [level=1] [ref=e14]
      - paragraph [ref=e15]: Get trusted local help, fast.
    - generic [ref=e16]:
      - button "I Need Help Post a task and connect with nearby helpers." [ref=e17] [cursor=pointer]:
        - img [ref=e19]
        - generic [ref=e21]:
          - heading "I Need Help" [level=2] [ref=e22]
          - paragraph [ref=e23]: Post a task and connect with nearby helpers.
        - img [ref=e24]
      - button "I Want to Work Find local tasks and start earning." [ref=e26] [cursor=pointer]:
        - img [ref=e28]
        - generic [ref=e31]:
          - heading "I Want to Work" [level=2] [ref=e32]
          - paragraph [ref=e33]: Find local tasks and start earning.
        - img [ref=e34]
    - button "Already have an account? Log In" [ref=e37] [cursor=pointer]:
      - generic [ref=e38]: Already have an account?
      - generic [ref=e39]: Log In
    - generic [ref=e40]: Connect • Help • Earn
```
