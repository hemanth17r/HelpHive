...
const AddressBookScreen = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-light-gray h-full relative z-20">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-4 border-b border-border bg-white sticky top-0 z-10 shrink-0 shadow-sm">
